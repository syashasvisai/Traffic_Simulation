...
When the project is built initially, all traffic lights will be green. Traffic simulation should run with red lights controlling traffic, just as in the .gif file above. 
